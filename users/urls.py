...
from .views import admin_profile, all_companies, approve_company, pending_companies, register_user, login_user, reject_company, send_otp, reset_password, update_admin_profile 
